...
def runstrategy():
    ...
    cerebro.addwriter(bt.WriterFile, csv=args.writercsv, rounding=2, out='logs\Vova_Test_2_results')
...
def parse_args():
    ...
    parser.add_argument('--data', '-d',
                        default='C:\\Users\\User\\PycharmProjects\\backtrader\\data\\JISL.csv',
